...
We didn't reach 500k+ QPS in one day. Here is how the project evolved:
...
# Run server on cores 0-11
taskset -c 0-11 ./mini_seastar


Pressure test with wrk:

# Run wrk on separate cores 12-15 to avoid interference
taskset -c 12-15 wrk -t4 -c1000 -d15s http://localhost:8080
